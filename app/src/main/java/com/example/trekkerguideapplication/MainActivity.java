...
import com.example.trekkerguideapplication.util.Constants;
...
public class MainActivity extends AppCompatActivity
    ...
    private List<TrekLocation> trekLocationList = new ArrayList<TrekLocation>();
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                trekLocation.setTitle(obj.getString("name"));
                                ...
                                for (int j = 0; j < descriptionsArry.length(); j++) {
                                    descriptions.add((String) descriptionsArry.get(j));
                                }
                                trekLocation.setDescription(descriptions);

                                // adding movie to movies array
                                trekLocationList.add(trekLocation);
